...
particlesJS('particles-js', {
  ...
  retina_detect: true
	...
	var rellax = new Rellax('#header-phone');
	...
	$('.butter').click(function(){
		$('.mobile__menu').toggleClass('mobile__menu-show');
	});
	
	$('.authorization__mobile').click(function(){
		$('.authorization__btns').toggleClass('authorization__btns-show');
	});
	
	$('.authorization__btns').click(function(){
		$('.authorization__btns').removeClass('authorization__btns-show');
	});
